...
interface AddInternationalTourFormProps {
  currentUser: User;
...
export function AddInternationalTourForm({ currentUser, onAddTour, onAddSlot, onShowNotification, onNavigateBack }: AddInternationalTourFormProps) {
